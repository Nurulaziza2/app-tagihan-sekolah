                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($item->tanggal->gt($item->tagihan->tanggal_jatuh_tempo))
                                    Terlambat
                                    {{ $telatHari = $item->tanggal->diffInDays($item->tagihan->tanggal_jatuh_tempo) }}
                                    Hari
                                @else
                    ...
                    <tr>
                        <td colspan="9" class="text-right">
                            <b>Total Keseluruhan Jumlah Pembayaran</b>
                        </td>
                        <td>
                            <b>Rp{{ number_format($model->sum('jumlah'), 0, ',', '.') }}</b>
                        </td>
