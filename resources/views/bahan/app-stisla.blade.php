...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('stisla') }}/pages/assets/modules/datatables/DataTables-1.10.16/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet"
        href="{{ asset('stisla') }}/pages/assets/modules/datatables/Select-1.2.4/css/select.bootstrap4.min.css">
    @yield('css')
    <!-- favicon -->
    <!-- Template CSS -->
...
<body>
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <form class="form-inline mr-auto">
                    <ul class="navbar-nav mr-3">
                        <li><a href="{{ asset('stisla') }}/#" data-toggle="sidebar" class="nav-link nav-link-lg"><i
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="{{ asset('stisla') }}/#" data-toggle="dropdown"
                    ...
                    <ul class="sidebar-menu">
                        ...
                        @if (auth()->user()->akses == 'admin')
                            ...
                            <li class="nav-item {{ Request::path() === 'biaya' ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('biaya.index') }}"><i
                                        class="fas fa-money-bill-wave"></i> <span>Data Biaya</span>
                                </a>
                            </li>
                        @else
                            <li class="nav-item {{ Request::path() === 'kelas' ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('kelas.index') }}"><i
                                        class="fas fa-pencil-ruler"></i> <span>Data Kelas</span>
                                </a>
                            </li>
                            <li class="nav-item {{ Request::path() === 'siswa' ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('siswa.index') }}"><i
                                        class="fas fa-user-graduate"></i> <span>Data Siswa</span>
                                </a>
                            </li>
                            <li class="nav-item {{ Request::path() === 'tagihan' ? 'active' : '' }}">
                                <a class="nav-link" href="{{ route('tagihan.index') }}"><i
                                        class="fas fa-money-bill"></i> <span>Data Tagihan</span>
                                </a>
                            </li>
                        @endif
    ...
    <script src="{{ asset('stisla') }}/pages/assets/modules/datatables/DataTables-1.10.16/js/dataTables.bootstrap4.min.js">
    </script>
